...
@frappe.whitelist()
def get_all_pos_invoices_for_day(start, end):
    """Get ALL POS invoices for the day regardless of profile"""
...
@frappe.whitelist() 
def get_all_sales_invoices_for_day(start, end):
    """Get ALL Sales invoices for the day regardless of profile"""
    return frappe.db.sql("""
